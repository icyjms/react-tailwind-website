      ...
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8">
        <div className="w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300">
          <img
            ...
            src="https://jamescabauatan-demo-users-image.s3.ap-southeast-2.amazonaws.com/single.png"
            alt="Single image"
          />
        ...
        <div className="w-full bg-gray-100 shadow-xl flex flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300">
          <img
            ...
            src="https://jamescabauatan-demo-users-image.s3.ap-southeast-2.amazonaws.com/double.png"
            alt="Single image"
          />
        ...
        <div className="w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300">
          <img
            className="w-20 mx-auto mt-[-3rem] bg-white"
            src="https://jamescabauatan-demo-users-image.s3.ap-southeast-2.amazonaws.com/triple.png"
            alt="Single image"
          />
